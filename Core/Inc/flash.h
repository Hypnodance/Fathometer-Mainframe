//
// Created by TonyGuo on 2023/2/6.
//

#ifndef FATHOMETER_MAINFRAME_FLASH_H
#define FATHOMETER_MAINFRAME_FLASH_H

/* Includes ------------------------------------------------------------------*/
#include "stm32f1xx.h"
#include "spi.h"

#define FLASH_SELECT                            HAL_GPIO_WritePin(nFLASH_CS_GPIO_Port, nFLASH_CS_Pin, GPIO_PIN_RESET)
#define FLASH_UNSELECT                          HAL_GPIO_WritePin(nFLASH_CS_GPIO_Port, nFLASH_CS_Pin, GPIO_PIN_SET)
...
#endif //FATHOMETER_MAINFRAME_FLASH_H
